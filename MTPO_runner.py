...
import torch
import transformers
from arguments import GRPOScriptArguments, ModelConfig, MTPOConfig
from dataset_processing import process_dataset
from datasets import load_dataset
from MTPO_Trainer import CustomTrainer
...
if __name__ == "__main__":
    parser = TrlParser((GRPOScriptArguments, MTPOConfig, ModelConfig))
